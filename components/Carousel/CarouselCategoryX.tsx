    ...
    >
      <CarouselContent>
        {articles.map((article) => (
          <CarouselItem key={article.articleId} className="md:basis-1/2 lg:basis-1/3 h-[100%] pr-[5%] flex items-center">
            <div className="h-[100%]">
              <Card className=" w-[100%] h-[100%]">
                <CardContent className="flex items-center justify-center w-[100%] h-[100%]">
                  <a href={article.webLink} className=" w-[100%] h-[100%] flex flex-col gap-7">
                    <div style={{ position: 'relative', width: '100%', height: '0', paddingBottom: '37.21%' }}>
                      <Image src={article.image} alt={article.title} layout="cover " width={645} height={240} style={{ objectFit: 'cover' }} className="w-[100%]"/>
                    </div>
